...
const complianceBullets = [
  { num: "01", text: <><strong className="text-green-950">Compliance awareness is non-negotiable.</strong> Content that ignores the regulatory environment signals to sophisticated buyers that you do not understand their world. Every piece we produce is reviewed for compliance language before delivery.</> },
  { num: "02", text: <><strong className="text-green-950">The right publications require real editorial relationships.</strong> The outlets your buyers read do not accept generic cold pitches. Getting placed requires knowing their editorial standards and building credibility over time.</> },
  { num: "03", text: <><strong className="text-green-950">Buyer sophistication means surface-level content converts nothing.</strong> The decision-makers in this vertical have deep domain knowledge. Content that does not reflect that depth does not earn their trust, regardless of how well it ranks.</> },
]
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-green-900 leading-tight mb-5">
                Operators research suppliers<br />before ICE.<br /><em className="text-green-600 not-italic">Are they finding you?</em>
              </h1>
            ...
            <div className="relative rounded-2xl overflow-hidden aspect-[4/3] shadow-2xl">
              <Image src="/igaming.webp" alt="iGaming SEO" fill className="object-cover" />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight mb-10">The market context your SEO<br />strategy has to navigate.</h2>
      ...
      <section className="py-20 bg-[#ede8de]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-[820px]">
            ...
            <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight mb-8">Three things that break general<br />agencies here.</h2>
            ...
            <div className="inline-flex items-center gap-3 mt-8 px-4 py-3 bg-green-100 border border-green-900/15 rounded-xl">
              ...
              <div>
                ...
                <div className="text-[11px] text-muted-foreground">iGaming B2B and financial services SEO specialists. 5+ years in regulated markets.</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#f5f0e8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[17px] text-muted-foreground max-w-[620px] leading-relaxed mb-12">Established players have spent years building the domain authority and editorial presence that gets them shortlisted. We close that gap.</p>
      ...
      <section className="py-20 bg-green-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="text-[17px] text-white/50 max-w-[580px] leading-relaxed mb-14">Every tactic applied with this vertical's specific compliance environment, publication landscape, and buyer behaviour in mind.</p>
      ...
      <section className="py-20 bg-[#ede8de]">
        <div className="max-w-[760px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-11">
            <span className="inline-block text-[11px] tracking-[.14em] uppercase text-green-600 font-semibold mb-4">iGaming SEO Questions</span>
            <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight">What iGaming B2B teams<br />ask us most.</h2>
          </div>
