...
export const metadata: Metadata = {
  ...
  description: "We help fintech companies get found by CFOs, CTOs, and procurement teams before the sales call happens. Authority backlinks, publication placements, podcast appearances, and compliance-aware content.",
}

const painPoints = [
  { icon: CreditCard, title: "Incumbents own every keyword your buyers search", desc: "Established banks and fintech incumbents have spent years building domain authority. They rank for everything. Trying to outspend them on ads is a race you can not win long term." },
  { icon: Shield, title: "Google holds your content to a higher standard", desc: "Financial content falls under YMYL rules. One piece of content that implies a return, misrepresents a product, or skips the right disclaimers can set you back significantly with Google and with regulators." },
  { icon: Users, title: "Your buyers make decisions before they contact you", desc: "A CFO evaluating payment solutions, a CTO sourcing a lending API, or a procurement team shortlisting vendors has already formed an opinion about who belongs in this space before your sales team sends a message." },
  { icon: Monitor, title: "Agencies that don't know fintech slow you down", desc: "Generic agencies write content about 'what is open banking' that attracts nobody relevant to your pipeline. They can not navigate compliance, they don't know which publications matter, and you spend more time correcting their work than benefiting from it." },
  { icon: Search, title: "AI models recommend your competitors when buyers research", desc: "When a head of finance asks ChatGPT or Perplexity which embedded finance providers to evaluate, your name needs to appear. Most fintech companies have not built the citation authority that gets them into those answers." },
  { icon: CreditCard, title: "Paid traffic stops the moment your budget pauses", desc: "Ad spend in fintech is some of the most expensive in B2B. And when the campaign stops, the pipeline stops. You need a channel that builds value over time, not one that resets to zero every month." },
]
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-[680px] mb-14">
            ...
            <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight mb-4">
              The obstacles are real.<br />And they are specific to your space.
            </h2>
            <p className="text-[17px] text-muted-foreground leading-relaxed">
              Fintech is not like selling software. Your buyers are sophisticated, risk-averse, and they research extensively before they take a call with anyone.
            </p>
          </div>
      ...
      <section className="py-28 bg-green-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold text-white leading-tight mb-4">
            We build the authority your<br className="hidden sm:block" />competitors took years to accumulate.
          </h2>
          <p className="text-[17px] text-white/55 max-w-[600px] leading-relaxed mb-14">
            Not through shortcuts. Through the actual signals that tell Google, publications, and your future clients that you are a serious player in financial services.
          </p>
      ...
      <section className="py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight mb-4">
            What this looks like<br className="hidden sm:block" />in practice for fintech.
          </h2>
          <p className="text-[17px] text-muted-foreground max-w-[600px] leading-relaxed mb-14">
            A B2B embedded finance provider competing against first-generation platforms with years of domain authority.
          </p>
