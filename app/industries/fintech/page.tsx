...
const complianceBullets = [
  { num: "01", text: <><strong className="text-green-950">YMYL standards require editorial depth generic writers cannot produce.</strong> Google assesses fintech content for demonstrated expertise and author credentials. Anonymous or surface-level content fails this standard and does not rank, regardless of technical SEO work.</> },
  { num: "02", text: <><strong className="text-green-950">FCA COBS 4.6 and equivalent regulations create hard content limits.</strong> Performance claims, implied returns, and misleading comparisons carry real regulatory risk. Agencies without this background produce content your legal team has to reject or rewrite entirely.</> },
  { num: "03", text: <><strong className="text-green-950">The publications and podcasts that move fintech procurement decisions require real industry relationships.</strong> Finextra and TechCrunch do not accept cold-pitched generic content. Getting placed requires knowing their editorial standards, which angles they respond to, and building credibility over time.</> },
]

const painPoints = [
  { title: "Stripe, Adyen, and first-generation fintechs own every keyword your buyers search", desc: "They have been building domain authority since before your company existed. Competing on the same head terms is not viable. You need to build authority in the gaps they have not prioritised." },
...
const solutions = [
  ...
  { icon: Search, title: "YMYL-compliant search visibility for evaluation terms", desc: "Topical clusters around the searches procurement teams make when evaluating fintech vendors. Compliance-reviewed, expert-attributed, optimised for LLM citation as well as traditional search.", pills: ["YMYL compliant", "LLM citation", "E-E-A-T"] },
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-green-900 leading-tight mb-5">
                Your buyers have already<br />Googled you.<br /><em className="text-green-600 not-italic">What did they find?</em>
              </h1>
            ...
            <div className="relative rounded-2xl overflow-hidden aspect-[4/3] shadow-2xl">
              <Image src="/fintech.webp" alt="Fintech SEO" fill className="object-cover" />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight mb-10">Why visibility in fintech<br />has never been harder to earn.</h2>
      ...
      <section className="py-20 bg-[#ede8de]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-[820px]">
            ...
            <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight mb-4">Three things that break generic<br />agencies in fintech.</h2>
      ...
      <section className="py-20 bg-[#f5f0e8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[17px] text-muted-foreground max-w-[620px] leading-relaxed mb-12">Established fintech platforms have spent years accumulating the domain authority and editorial presence that gets them shortlisted. We close that gap.</p>
      ...
      <section className="py-20 bg-green-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold text-white leading-tight mb-4">Authority signals built for<br />the fintech buyer journey.</h2>
          <p className="text-[17px] text-white/50 max-w-[580px] leading-relaxed mb-14">Every tactic applied with fintech's specific compliance environment, publication landscape, and buyer behaviour in mind.</p>
