...
export const metadata: Metadata = {
  title: "Neobank SEO Agency | Revflow",
  description: "Content strategy for challenger banks competing against incumbents with decades of domain authority.",
}
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-green-900 leading-tight mb-6">Neobanks &amp; Digital Banking</h1>
          <p className="text-lg text-muted-foreground leading-relaxed mb-10">
            Content strategy for challenger banks competing against incumbents with decades of domain authority and brand recognition.
          </p>
          <div className="bg-white border border-green-900/10 rounded-2xl p-8 mb-8">
            ...
            <ul className="grid gap-3">
              {["Digital banking content", "Product differentiation copy", "Customer education articles", "Banking SEO strategy", "Brand authority building"].map((item) => (
