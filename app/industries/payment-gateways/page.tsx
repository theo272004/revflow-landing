...
import { Search, Shield, Users, CreditCard, Link2, Mic } from "lucide-react"
...
const faqs = [
  ...
  { q: "How do you help us compete against Stripe and Adyen for organic visibility?", a: "Not by targeting the same keywords they dominate. We identify the specific merchant searches around your actual differentiators: your pricing model, your supported payment methods, your regional strength, your vertical expertise. You own those conversations because you have the real depth to answer them and they have not bothered to go there." },
  { q: "We are entering a new market. How does content help us establish credibility there?", a: "We build market-specific content that addresses the regulatory environment, local payment methods, and merchant concerns specific to that region. This positions you as a provider that understands the local market before you have a local track record. It also generates the search visibility and publication placement that makes your sales conversations warmer from the first contact." },
  { q: "Our buyers are CTOs and CFOs. Do they actually use content to evaluate vendors?", a: "Yes, and they are the most thorough researchers in B2B. A CTO evaluating payment infrastructure will read your documentation, look for your name in industry publications, check if your executives have published anything credible, and research how you are talked about outside your own marketing. All of that is content. We build the pieces they find and form opinions from." },
  { q: "Which publications reach the payments audience we are trying to reach?", a: "Payments Source, The Paypers, Finextra, and fintech newsletters with genuine readership in the payments space. For B2B gateway and processor audiences specifically, these are significantly more valuable than general business publications because they reach the people who actually make payment infrastructure decisions, not just general finance readers." },
]
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-[680px] mb-14">
            ...
            <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight mb-4">Payments is a trust-first category.<br />Most processors are invisible before the first call.</h2>
            <p className="text-[17px] text-muted-foreground leading-relaxed">A merchant integrating a payment gateway is making a decision that affects every transaction their business processes. They are not going to trust a name they have never seen mentioned anywhere credible.</p>
          </div>
      ...
      <section className="py-24 bg-green-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold text-white leading-tight mb-4">We build the presence that gets you<br />into every shortlist that matters.</h2>
          <p className="text-[17px] text-white/55 max-w-[600px] leading-relaxed mb-14">We translate your real technical and commercial advantages into content that reaches the decision-makers who need to know about them, in the publications and search results they actually use.</p>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight mb-4">What this looks like<br />for a payment processor.</h2>
          <p className="text-[17px] text-muted-foreground max-w-[600px] leading-relaxed mb-14">A B2B payment gateway entering a new regional market with no existing brand recognition and strong local competition.</p>
          ...
          <div className="bg-white border border-green-900/10 rounded-2xl p-9 mt-9">
            ...
            <p className="text-[15px] text-muted-foreground leading-relaxed">The company had a technically strong product and genuine advantages in cross-border transaction processing but no recognition in the markets they were entering. Local payment processors had been in those markets for years. We built a content cluster entirely around the payment compliance, cross-border settlement, and merchant acquisition questions that their target buyers were actively researching. Within six weeks they had their first feature placement in a regional payments publication. Within four months, inbound from organic was converting at a significantly higher rate than outbound because the merchants who arrived had already read enough about them to trust the conversation.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#ede8de]">
        <div className="max-w-[720px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-11">
            ...
            <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight">Payments-specific questions<br />we get asked often.</h2>
          </div>
      ...
      <section className="py-28 bg-green-900 relative overflow-hidden text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-4">
            Merchants are shortlisting payment<br /><em className="text-green-400 not-italic">providers right now.</em>
          </h2>
