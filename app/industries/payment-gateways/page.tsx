...
const solutions = [
  ...
  { icon: Mail, title: "Editorial placements in publications merchants actually read", desc: "Your content placed in Payments Source, The Paypers, PYMNTS, and Finextra. These are the outlets payments procurement teams and industry analysts read. Third-party editorial credibility that no owned channel can replicate.", pills: ["Payments Source", "The Paypers", "PYMNTS"] },
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
      ...
      <section className="pt-44 pb-24 relative overflow-hidden min-h-[80vh] flex items-center">
        <div className="absolute inset-0 z-0">
          <Image src="/revflow-landing/payment-gateway.webp" alt="Payment Gateway SEO" fill priority quality={100} className="object-cover object-center" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="flex flex-col items-center text-center max-w-[780px] mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[66px] font-extrabold text-white leading-[1.07] mb-5">
              Merchants shortlist five payment providers<br /><em className="text-green-400 not-italic">before contacting any of them.</em>
            </h1>
          ...
          <div className="max-w-[820px]">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-start gap-3.5">
                ...
                <p className="text-[14px] text-muted-foreground leading-relaxed"><strong className="text-green-950">PCI DSS language has to be precisely accurate or it creates regulatory and credibility risk.</strong> Content that misrepresents certification level, overstates security capabilities, or makes unauthorized claims about card scheme relationships creates real exposure. Merchants who work with PCI QSAs know exactly what your certification claims mean. We get this right.</p>
              </div>
              <div className="flex items-start gap-3.5">
                ...
                <p className="text-[14px] text-muted-foreground leading-relaxed"><strong className="text-green-950">The publications reaching payments procurement teams require real editorial relationships to access.</strong> Payments Source, The Paypers, and PYMNTS do not accept generic cold pitches. Getting placed requires understanding their editorial standards and building credibility over time. We have those relationships.</p>
              </div>
              <div className="flex items-start gap-3.5">
                ...
                <p className="text-[14px] text-muted-foreground leading-relaxed"><strong className="text-green-950">Enterprise merchant due diligence spans weeks. Your content has to be present during that entire window.</strong> A CTO evaluating payment infrastructure typically spends four to twelve weeks researching before engaging vendors. Your content needs to be visible and credible across that entire period, not just at the moment your sales team makes contact.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-[110px] bg-green-900 relative overflow-hidden text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-4xl sm:text-5xl lg:text-[56px] font-extrabold text-white leading-[1.1] mb-3.5">
            Merchants are shortlisting payment<br />providers <em className="text-green-400 not-italic">right now.</em>
          </h2>
