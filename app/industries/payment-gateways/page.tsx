...
export const metadata: Metadata = {
  title: "SEO for Payment Gateways | Revflow",
  description: "Content that builds trust for payment processors and acquirers in regulated merchant markets.",
}
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-green-900 leading-tight mb-6">Payment Gateways</h1>
          <p className="text-lg text-muted-foreground leading-relaxed mb-10">
            Content that builds trust for processors and acquirers selling into regulated merchant markets where security and compliance are top of mind.
          </p>
          <div className="bg-white border border-green-900/10 rounded-2xl p-8 mb-8">
            ...
            <ul className="grid gap-3">
              {["Payment industry expertise", "PCI DSS-aware content", "B2B buyer-focused copy", "Cross-border payment content", "Merchant education articles"].map((item) => (
