          ...
          <div className="grid lg:grid-cols-2 gap-[72px] items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-[66px] font-extrabold text-green-900 leading-[1.07] mb-5">
                Merchants shortlist five payment providers<br /><em className="text-green-600 not-italic">before contacting any of them.</em>
              </h1>
            ...
            <div className="relative rounded-2xl overflow-hidden">
              <img src="/revflow-landing/payment-gateway.webp" alt="Payment Gateway SEO" className="w-full object-cover rounded-2xl" />
            </div>
          </div>
        </div>
      </section>
