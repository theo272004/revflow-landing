...
export const metadata: Metadata = {
  title: "InsurTech SEO | Revflow",
  description: "SEO and thought leadership for insurance technology companies in a legacy-dominated market.",
}
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-green-900 leading-tight mb-6">InsurTech</h1>
          <p className="text-lg text-muted-foreground leading-relaxed mb-10">
            SEO and thought leadership for insurance technology companies in a category dominated by legacy brands with massive domain authority.
          </p>
          <div className="bg-white border border-green-900/10 rounded-2xl p-8 mb-8">
            ...
            <ul className="grid gap-3">
              {["Insurance tech content", "Industry expert sourcing", "Regulatory-aware copy", "Product education articles", "Authority building strategy"].map((item) => (
