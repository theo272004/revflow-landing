  ...
  return (
    <main className="min-h-screen bg-[#f5f0e8]">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-green-900 leading-tight mb-5">
                You cannot outspend<br />IG Group.<br /><em className="text-green-600 not-italic">You can outrank them on trust.</em>
              </h1>
      ...
      <section className="py-20 bg-[#ede8de]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-[820px]">
            ...
            <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight mb-4">Three things that break general<br />agencies in brokerage.</h2>
      ...
      <section className="py-20 bg-green-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <span className="inline-block text-[11px] tracking-[.14em] uppercase text-green-400 font-semibold mb-4">What We Build for Forex Brokers</span>
      ...
      <section className="py-20 bg-[#f5f0e8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[2fr_3fr] gap-16 items-start">
            <div>
              <span className="inline-block text-[10px] tracking-[.12em] uppercase text-green-600 font-semibold mb-3">If you came to us as a forex broker</span>
      ...
      <section className="py-20 bg-[#ede8de]">
        <div className="max-w-[760px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-11">
            <span className="inline-block text-[11px] tracking-[.14em] uppercase text-green-600 font-semibold mb-4">Broker SEO Questions</span>
            <h2 className="text-3xl lg:text-4xl font-extrabold text-green-900 leading-tight">What broker marketing<br />teams ask us most.</h2>
          </div>
