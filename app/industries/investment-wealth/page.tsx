...
export const metadata: Metadata = {
  title: "SEO for Investment & Wealth | Revflow",
  description: "Editorial content for asset managers, robo-advisors, and wealth platforms that need to earn trust.",
}
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-green-900 leading-tight mb-6">Investment &amp; Wealth Management</h1>
          <p className="text-lg text-muted-foreground leading-relaxed mb-10">
            Editorial content for asset managers, robo-advisors, and wealth platforms that need to earn trust before they earn clients.
          </p>
          <div className="bg-white border border-green-900/10 rounded-2xl p-8 mb-8">
            ...
            <ul className="grid gap-3">
              {["Wealth management content", "Investment education", "Compliance-reviewed analysis", "Advisor thought leadership", "Client acquisition content"].map((item) => (
