...
export const metadata: Metadata = {
  title: "LinkedIn Content Strategy | Revflow",
  description: "Thought leadership and consistent presence for financial decision-makers on LinkedIn.",
}
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-green-900 leading-tight mb-6">LinkedIn Content Strategy</h1>
          <p className="text-lg text-muted-foreground leading-relaxed mb-10">
            The primary channel for financial decision-makers. Thought leadership and consistent presence in the feed of your exact buyer profile.
          </p>
          <div className="bg-white border border-green-900/10 rounded-2xl p-8 mb-8">
            ...
            <ul className="grid gap-3">
              {["Executive LinkedIn optimization", "Content calendar &amp; scheduling", "Thought leadership posts", "Engagement strategy", "Analytics &amp; reporting"].map((item) => (
