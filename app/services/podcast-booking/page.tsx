...
export const metadata: Metadata = {
  title: "Podcast Booking | Revflow",
  description: "Book your founders on fintech and finance podcasts where your buyers actually listen.",
}
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-green-900 leading-tight mb-6">Podcast Booking</h1>
          <p className="text-lg text-muted-foreground leading-relaxed mb-10">
            We book your founders on fintech, payments, and investment shows where your buyers actually listen. Trust built through conversation, not advertising.
          </p>
          <div className="bg-white border border-green-900/10 rounded-2xl p-8 mb-8">
            ...
            <ul className="grid gap-3">
              {["Finance podcast identification", "Outreach &amp; booking", "Guest prep &amp; talking points", "Episode promotion", "Long-form content repurposing"].map((item) => (
