...
export const metadata: Metadata = {
  title: "YouTube & Video Content | Revflow",
  description: "Scripted video production aligned with your SEO strategy. Video that ranks on YouTube and Google.",
}
    ...
    <main className="min-h-screen bg-[#f5f0e8]">
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-green-900 leading-tight mb-6">YouTube &amp; Video Content</h1>
          <p className="text-lg text-muted-foreground leading-relaxed mb-10">
            Scripted video production aligned with your written content clusters. Video that ranks on YouTube and reinforces your SEO strategy.
          </p>
          <div className="bg-white border border-green-900/10 rounded-2xl p-8 mb-8">
            ...
            <ul className="grid gap-3">
              {["Video scripting &amp; storyboarding", "SEO-optimized YouTube descriptions", "Thumbnail &amp; title optimization", "Content repurposing from articles", "Channel growth strategy"].map((item) => (
